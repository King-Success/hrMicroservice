...
<div class="row-col info h-v p-t-lg">
	...
	<div class="col-sm-5">
		<div class="p-a-lg">
			<h3 class="m-y-lg">One-Stop Admin theme</h3>
			<p class="text-muted m-b-lg text-md">Your one-stop admin dashboard. You'll find a bunch of widgets, useful components. Easy to get started.</p>
			<a href="https://themeforest.net/user/flatfull/portfolio?ref=flatfull" class="btn rounded btn-outline b-white b-2x m-b-lg p-x-md">Get it now</a>
		</div>
	</div>
	<div class="col-sm-6" style="min-height: 320px; background-image:url(images/dashboard.png); background-size: cover">
	</div>
</div>
<div class="p-y-lg b-b box-shadow-z0 dark-white" id="features">
	<div class="container p-y-md">
		<h4 class="text-center m-b-lg">Powerful Admin Template</h4>
		<div class="row">
...
<div class="dark-light" id="demos">
	<div class="container">
		<div class="p-a-lg text-center">
			<h2 class="m-b-lg">What you get with aside template</h2>
			<p>
			...
			<div class="row">
				<div class="col-xs-4">
					<div>
						...
						<a href="dashboard.html?bg=black" class="item-media item-media-4by3 margin box-shadow-z3" style="background-image: url(/images/dark.png);background-size: cover">
						</a>
						...
						<a href="app.contact.html" class="item-media item-media-4by3 margin box-shadow-z3" style="background-image: url(/images/contact.png);background-size: cover">
						</a>
						<div class="item-media item-media-4by3 margin box-shadow-z3">
				...
				<div class="col-xs-4">
					<div>
						...
						<a href="chartjs.html" class="item-media item-media-4by3 margin box-shadow-z3" style="background-image: url(/images/chart.png);background-size: cover">
						</a>
						<div class="item-media item-media-4by3 margin box-shadow-z3">
						...
						<a href="dashboard.html?bg=" class="item-media item-media-4by3 margin box-shadow-z3" style="background-image: url(/images/dashboard.png);background-size: cover">
						</a>
						<div class="item-media item-media-4by3 margin box-shadow-z3">
						...
						<a href="app.message.html" class="item-media item-media-4by3 margin box-shadow-z3" style="background-image: url(/images/message.png);background-size: cover">
						</a>
					</div>
				</div>
				<div class="col-xs-4">
					<div>
						...
						<a href="app.project.html" class="item-media item-media-4by3 margin box-shadow-z3" style="background-image: url(/images/project.png);background-size: cover">
						</a>
						<a href="map.vector.html" class="item-media item-media-4by3 margin box-shadow-z3" style="background-image: url(/images/map.png);background-size: cover">
						</a>
						<div class="item-media item-media-4by3 margin box-shadow-z3">
						...
						<a href="app.inbox.html" class="item-media item-media-4by3 margin box-shadow-z3" style="background-image: url(/images/inbox.png);background-size: cover">
						</a>
						<div class="item-media item-media-4by3 margin box-shadow-z3">
  ...
  <div class="footer black text-info-hover">
  	<div class="container">
  		<div class="p-y-lg b-b">
  			<a href="https://themeforest.net/user/flatfull/portfolio?ref=flatfull" class="btn info rounded pull-right pull-none-xs">Get it now</a>
  			<div class="m-r">
  				<div class="text-md p-y-sm">Our Admin themes Trusted by 18,000+ businesses worldwide, Do not miss them!</div>
  			</div>
  		</div>
  	</div>
  	<div class="container">
  		<div class="row p-y-lg">
  			<div class="col-md-5">
  				...
  				<p class="m-t-md text-muted p-r-lg">
  					<small class="text-muted">You can use it to build your Content manage system, CRM, Task app, Travel app, Medical app...</small>
  				</p>
  				<div class="text-muted m-y-lg">
  					<h2 class="text-muted _600">
  						<span class="text-muted">aside</span>
  					</h2>
  				</div>
  			</div>
