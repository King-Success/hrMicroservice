            ...
            <div class="b-t">
                <div class="center-block w-xxl w-auto-xs p-y-md text-center">
                    <div class="p-a-md">
                        ...
                        -->
                        <form name="form" action="/dashboard">
                            ...
                            <!-- <div class="m-b-md"><label class="md-check"><input type="checkbox"><i class="primary"></i> Keep me signed in</label></div> -->
                            <button type="submit" class="btn btn-lg black p-x-lg">Sign in</button>
                        </form>
                        <!-- <div class="m-y"><a href="forgot-password.html" class="_600">Forgot password?</a></div> -->
                        <!-- <div>Do not have an account? <a href="signup.html" class="text-primary _600">Sign up</a></div> -->
                    </div>
                </div>
            </div>
        </div>
